...
Write-Host "Test output: website-test-v38"
Write-Host "PNG metadata: XMP/PNG-safe only"
Write-Host "JPEG/TIFF metadata: genealogy fields preserved"
...
Write-Host "PNG derivatives use XMP-safe metadata only."
