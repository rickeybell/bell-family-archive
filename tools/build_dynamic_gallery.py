...
def page(title,subtitle,items,filename,empty_html='',after_html=''):
    ...
    group_style='''.archive-card-wide>.archive-multi-pic{height:100%;min-height:480px}.archive-multi-pic{display:grid;grid-template-columns:1fr;grid-template-rows:repeat(2,minmax(240px,1fr));gap:2px;background:#ddd}.archive-multi-pic>.archive-pic{height:100%;min-height:240px}.archive-multi-pic>.archive-pic img{height:100%;min-height:240px;object-fit:contain}.archive-card-group .archive-actions{flex-wrap:wrap}@media(max-width:780px){.archive-card-wide>.archive-multi-pic{height:auto;min-height:0}.archive-multi-pic{grid-template-columns:1fr;grid-template-rows:repeat(2,180px)}.archive-multi-pic>.archive-pic,.archive-multi-pic>.archive-pic img{min-height:180px;height:180px}}''' if any(x.get('_group_items') for x in ordered) else ''
