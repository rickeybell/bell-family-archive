...
import {alwaysVisibleTrafficIdentifiers,klkrAreaModeEnabled,klkrCircleEnabled,klkrTrafficArea,radarCoverageWithinKlkrArea,trafficHasConstantLabel,trafficPollingNeeded,trafficVisibleAtZoom,trafficWithinKlkrArea} from './traffic-display.mjs?v=20260921-klkr-area2';
...
async function loadTraffic(){
 ...
 catch{$('traffic-toggle').classList.remove('traffic-live');if(!trafficAircraft.length){$('traffic-toggle').classList.add('traffic-error');$('traffic-toggle').title='GA traffic is temporarily unavailable';}}
