...
export const klkrTrafficArea=Object.freeze({lat:34.72659,lon:-80.85316,radiusSm:30,maxRadarCoverage:.2});
...
export function klkrAreaModeEnabled({trafficOn,zoom,klkrVisible,radarCoverage}){return Boolean(trafficOn&&Math.abs(Number(zoom)-1)<.001&&klkrVisible&&Number.isFinite(radarCoverage)&&radarCoverage<klkrTrafficArea.maxRadarCoverage);}
