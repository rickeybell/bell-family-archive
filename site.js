...
document.addEventListener("DOMContentLoaded",()=>{
  ...
  document.querySelectorAll(".portrait-wrap img, #extended-family .archive-community-photo img, #family-friends .archive-community-photo img, #family-pets .archive-community-photo img, #family-hobbies .archive-community-photo img, #fallen-first-responders .archive-community-photo img").forEach(img=>img.addEventListener("click",()=>{if(box&&boxImg){boxImg.src=img.src;boxImg.alt=img.alt||"";box.classList.add("open");box.setAttribute("aria-hidden","false");}}));
