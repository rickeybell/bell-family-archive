...
Write-Section "Bell Family Archive - MOV to MP4 Converter v1.2"
...
# Recursively find MOV files, but completely exclude DigiKam .dtrash trees.
# This excludes .dtrash at the Pictures root and any nested .dtrash directory.
